...
public class MailUtils {
	...
	private static String USERNAME = "colorfulwy@163.com";//邮箱帐号
	private static String PASSWORD = "luowenxin666";//邮箱密码（对于网易邮箱，这里是授权码，不是真正的密码）
	private static String FROM = "colorfulwy@163.com";//发送的邮箱地址
